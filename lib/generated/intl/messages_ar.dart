...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "add_address_for_a_faster_checkout": MessageLookupByLibrary.simpleMessage(
      "أضف عنوانًا لإنهاء الطلب بشكل أسرع",
    ),
    ...
    "added_to_wishlist": MessageLookupByLibrary.simpleMessage(
    ...
    "cancelNote": MessageLookupByLibrary.simpleMessage("سبب الرفض"),
    ...
    "deliveryDate": MessageLookupByLibrary.simpleMessage("وقت التوصيل"),
    ...
    "email_contain_validation": MessageLookupByLibrary.simpleMessage(
      "يجب أن يحتوي البريد الإلكتروني على @",
    ),
    "email_required_validation": MessageLookupByLibrary.simpleMessage(
    ...
    "extra_directions_": MessageLookupByLibrary.simpleMessage(
      "تعليمات إضافية*",
    ),
    "failure_update_message": MessageLookupByLibrary.simpleMessage(
      "لم يتم تحديث حسابك بنجاح",
    ),
    ...
    "lorem_small": MessageLookupByLibrary.simpleMessage(
    ...
    "password_confirm_validation": MessageLookupByLibrary.simpleMessage(
    ...
    "password_reset_link": MessageLookupByLibrary.simpleMessage(
    ...
    "return_policy_data": MessageLookupByLibrary.simpleMessage(
      "بيانات سياسة الإرجاع .....",
    ),
    ...
    "terminate_message": MessageLookupByLibrary.simpleMessage(
      "هل تريد إنهاء حسابك؟",
    ),
    "terminate_my_accounts": MessageLookupByLibrary.simpleMessage(
      "إنهاء حساباتي",
    ),
    "terminate_note_message": MessageLookupByLibrary.simpleMessage(
      "بإنهاء الحساب، لن تتمكن من استعادة حسابك.",
    ),
    "terms_conditions": MessageLookupByLibrary.simpleMessage("الشروط والأحكام"),
    "thank_you_for_your_purchase": MessageLookupByLibrary.simpleMessage(
      "شكرًا لشرائك",
    ),
